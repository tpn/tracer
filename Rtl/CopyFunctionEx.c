...
Abstract:
    ...
    This module implements the CopyFunctionEx routine.
...
CopyFunction(
    ...
    PADJUST_THUNK_POINTERS_EX AdjustThunkPointersEx,
    ...
    PPVOID DestWritableDataAddressPointer,
    PPVOID DestUserDataAddressPointer,
    PPVOID DestWritableUserDataAddressPointer,
    ...
    )
{
    ...
    *EntryCountPointer = 0;
    ...
    Success = AdjustThunkPointersEx(Rtl,
                                    TargetProcessHandle,
                                    ThunkBuffer,
    ...
    if (!AdjustUserDataPointersEx) {
        goto WriteMemory;
    }

    Success = AdjustUserDataPointersEx(Rtl,
                                       TargetProcessHandle,
                                       UserData,
