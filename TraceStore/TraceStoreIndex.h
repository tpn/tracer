...
typedef enum _TRACE_STORE_INDEX {
    ...
    TraceStoreFileIndex,
    TraceStoreFileMetadataInfoIndex,
    TraceStoreFileAllocationIndex,
    TraceStoreFileRelocationIndex,
    TraceStoreFileAddressIndex,
    TraceStoreFileAddressRangeIndex,
    TraceStoreFileAllocationTimestampIndex,
    TraceStoreFileAllocationTimestampDeltaIndex,
    TraceStoreFileInfoIndex,
    TraceStoreLineIndex,
