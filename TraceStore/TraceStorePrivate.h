...
SUBMIT_CLOSE_MEMORY_MAP_THREADPOOL_WORK SubmitCloseMemoryMapThreadpoolWork;
...
PREFAULT_FUTURE_TRACE_STORE_PAGE_CALLBACK PrefaultFutureTraceStorePageCallback;
