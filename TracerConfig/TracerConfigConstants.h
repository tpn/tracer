...
TRACER_CONFIG_DATA CONST UNICODE_STRING AsmDllPath;
TRACER_CONFIG_DATA CONST UNICODE_STRING RtlDllPath;
TRACER_CONFIG_DATA CONST UNICODE_STRING PythonDllPath;
TRACER_CONFIG_DATA CONST UNICODE_STRING TracerCoreDllPath;
...
TRACER_CONFIG_DATA CONST UNICODE_STRING InjectionThunkDllPath;
