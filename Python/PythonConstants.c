...
CONST PYCODEOBJECTOFFSETS PyCodeObjectOffsets36_37 = {
    FIELD_OFFSET(PYCODEOBJECT36_37, ArgumentCount),
    FIELD_OFFSET(PYCODEOBJECT36_37, KeywordOnlyArgumentCount),
    FIELD_OFFSET(PYCODEOBJECT36_37, NumberOfLocals),
    FIELD_OFFSET(PYCODEOBJECT36_37, StackSize),
    FIELD_OFFSET(PYCODEOBJECT36_37, Flags),
    FIELD_OFFSET(PYCODEOBJECT36_37, Code),
    FIELD_OFFSET(PYCODEOBJECT36_37, Constants),
    FIELD_OFFSET(PYCODEOBJECT36_37, Names),
    FIELD_OFFSET(PYCODEOBJECT36_37, LocalVariableNames),
    FIELD_OFFSET(PYCODEOBJECT36_37, FreeVariableNames),
    FIELD_OFFSET(PYCODEOBJECT36_37, CellVariableNames),
    FIELD_OFFSET(PYCODEOBJECT36_37, Filename),
    FIELD_OFFSET(PYCODEOBJECT36_37, Name),
    FIELD_OFFSET(PYCODEOBJECT36_37, FirstLineNumber),
    FIELD_OFFSET(PYCODEOBJECT36_37, LineNumberTable),
    FIELD_OFFSET(PYCODEOBJECT36_37, ZombieFrame),
    FIELD_OFFSET(PYCODEOBJECT36_37, WeakrefList),
    FIELD_OFFSET(PYCODEOBJECT36_37, Extra),
};
...
CONST PYFRAMEOBJECTOFFSETS PyFrameObjectOffsets34_37 = {
    0, // ThreadState
    FIELD_OFFSET(PYFRAMEOBJECT34_37, LastInstruction),
    FIELD_OFFSET(PYFRAMEOBJECT34_37, LineNumber),
    FIELD_OFFSET(PYFRAMEOBJECT34_37, BlockIndex),
    FIELD_OFFSET(PYFRAMEOBJECT34_37, BlockStack),
    FIELD_OFFSET(PYFRAMEOBJECT34_37, LocalsPlusStack),
    FIELD_OFFSET(PYFRAMEOBJECT34_37, Generator),
    FIELD_OFFSET(PYFRAMEOBJECT34_37, StillExecuting)
};
