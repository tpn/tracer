...
} DEBUG_ENGINE_SESSION;
typedef DEBUG_ENGINE_SESSION *PDEBUG_ENGINE_SESSION;
typedef DEBUG_ENGINE_SESSION **PPDEBUG_ENGINE_SESSION;
...
--*/
{
    ...
    Success = LoadStringTableApi(Rtl,
                                 &StringTableModule,
                                 StringTableDllPath,
                                 sizeof(StringTableApi),
                                 (PSTRING_TABLE_ANY_API)&StringTableApi);
