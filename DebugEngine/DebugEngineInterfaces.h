...
typedef IDEBUGSYSTEMOBJECTS4 *PIDEBUGSYSTEMOBJECTS4;

typedef struct IDebugSystemObjects4Vtbl IDEBUGSYSTEMOBJECTS4VTBL;
typedef IDEBUGSYSTEMOBJECTS4VTBL *PIDEBUGSYSTEMOBJECTS4VTBL;

typedef IDEBUGSYSTEMOBJECTS4     IDEBUGSYSTEMOBJECTS;
typedef IDEBUGSYSTEMOBJECTS   *PIDEBUGSYSTEMOBJECTS;
typedef IDEBUGSYSTEMOBJECTS **PPIDEBUGSYSTEMOBJECTS;

typedef IDEBUGSYSTEMOBJECTS4VTBL   DEBUGSYSTEMOBJECTS;
typedef DEBUGSYSTEMOBJECTS      *PDEBUGSYSTEMOBJECTS;
typedef DEBUGSYSTEMOBJECTS    **PPDEBUGSYSTEMOBJECTS;

//
// IDebugBreakpoint2
//

typedef struct IDebugBreakpoint2 IDEBUGBREAKPOINT2;
typedef IDEBUGBREAKPOINT2 *PIDEBUGBREAKPOINT2;

typedef struct IDebugBreakpoint2Vtbl IDEBUGBREAKPOINT2VTBL;
typedef IDEBUGBREAKPOINT2VTBL *PIDEBUGBREAKPOINT2VTBL;

typedef IDEBUGBREAKPOINT2      IDEBUGBREAKPOINT;
typedef IDEBUGBREAKPOINT     *PIDEBUGBREAKPOINT;
typedef IDEBUGBREAKPOINT   **PPIDEBUGBREAKPOINT;

typedef IDEBUGBREAKPOINT2VTBL     DEBUGBREAKPOINT;
typedef DEBUGBREAKPOINT         *PDEBUGBREAKPOINT;
typedef DEBUGBREAKPOINT       **PPDEBUGBREAKPOINT;
...
CGUID IID_IDEBUG_SYSTEMOBJECTS;
