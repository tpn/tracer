...
typedef VOID (CALLBACK *PHOOK_CALLBACK)(
    _In_ PHOOKED_FUNCTION_CALL Call
    );

typedef PHOOK_CALLBACK PHOOK_ENTRY;
typedef PHOOK_CALLBACK PHOOK_ENTRY_CALLBACK;
typedef PHOOK_CALLBACK PHOOK_EXIT;
typedef PHOOK_CALLBACK PHOOK_EXIT_CALLBACK;
