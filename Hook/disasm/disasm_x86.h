...
// Instruction setup
BOOL X86_InitInstruction(PRTL Rtl, struct _INSTRUCTION *Instruction);
void X86_CloseInstruction(PRTL Rtl, struct _INSTRUCTION *Instruction);

// Instruction translator
BOOL X86_TranslateInstruction(PRTL Rtl, struct _INSTRUCTION *Instruction, BOOL Verbose);

// Instruction decoder
BOOL X86_GetInstruction(PRTL Rtl, struct _INSTRUCTION *Instruction, U8 *Address, DWORD Flags);

// Function finding
U8 *X86_FindFunctionByPrologue(PRTL Rtl, struct _INSTRUCTION *Instruction, U8 *StartAddress, U8 *EndAddress, DWORD Flags);
