...
class SyncRtlHeaderOld(InvariantAwareCommand):
    """
...
class SyncRtlExFunctionsCommand(InvariantAwareCommand):
    """
...
class SyncHeadFuncPointerStruct(InvariantAwareCommand):
    """
    Compares the members of _RTLEXFUNCTIONS_HEAD to symbols resolved in
    LoadRtlExSymbols() function and adds the necessary GetProcAddress()
    steps.
