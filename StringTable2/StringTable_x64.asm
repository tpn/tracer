...
;
; Nested entry with rsi/rdi for compares.
;
...
;
; We
; subtract 8 from LOCALS_SIZE when restoring rsp to account for the popfq
; instruction prior, which will deallocate the 8 bytes of local stack space
; for the rflags automatically.
;
