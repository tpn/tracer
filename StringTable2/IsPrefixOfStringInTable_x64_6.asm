...
;
;   This routine is identical to version 5, except it uses 'dec cx; jnz @B'
;   instead of 'loopnz @B' during the long string comparison (where the slot
;   length and search string length are longer than 16).
;
; Arguments:
;
...
;--
        ...
        LEAF_ENTRY IsPrefixOfStringInTable_x64_6, _TEXT$00
...
;
        ...
        jnz         @B                          ; Jump back and continue loop.
...
@@:     vpextrb     r10, xmm4, 1                ; Restore r10.
        ...
        LEAF_END   IsPrefixOfStringInTable_x64_6, _TEXT$00
