...
;
;   This routine is based on version 15, but uses a load-op for vpminub using
;   a static byte array.
;
...
;--
        ...
        LEAF_ENTRY IsPrefixOfStringInTable_x64_16, _TEXT$00
...
Pfx10:  mov         r9, 16                      ; Load 16 into r9.
        vpminub     xmm4, xmm4, xmmword ptr [MinTbl] ; Find min slot len.
        vpextrb     r11, xmm4, 0                ; Load string length.
        vpextrb     r10, xmm4, 1                ; Load search length.
...
;
        ...
        LEAF_END   IsPrefixOfStringInTable_x64_16, _TEXT$00
